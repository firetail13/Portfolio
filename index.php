...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
  ...
  <body>
    <a id="top">
    <nav class="navbar">
            <div class="nav-logo"><img class="logo-image" src="img/logo.png" alt="logo"></div>
            <ul class="nav-menu">
              <li class="nav-item">
                    <a href="#top">Home</a>
                </li>
    ...
    <div class="flex h-screen bg-black">
      <div class="w-1/2 flex flex-col justify-center px-8">
        ...
        <h1 class="text-white text-4xl mb-8 leading-tight-none auto-type-name">I'm <span class="auto-input"></span></h1>
        <p class="text-gray-400 mb-8">Click below to download my resume and if you want to learn more about me feel free to contact me!</p>
        <div>
        <a class="font-lato resume-download-button" href="#">Download Resume</a>
        <a class="font-lato contact-button" href="#contact">Contact Me</a>
      </div>
      </div>
      </div>
    ...
    <main>
      ...
      <div class="main-body-container">
        <section id="about-container">
          ...
          <h2>About</h2>
          <p>I'm a web designer & front-end developer focused on crafting clean & user-friendly experiences, I an passsionate about building excellent software that improves the lives of those around me.</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content aos-init aos-animate" data-aos="fade-left">
            ...
            <p class="fst-italic">
              I have previously studied Cert IV of Web-based Technology and I am currently finishing a Diploma of Website Development, during this time I completed a variety of UX Design related tasks on top of my website development tasks.</p>
            <div class="row">
              ...
              <div class="col-lg-6 about-content">
                <ul>
                  ...
                  <li><strong>Degree:</strong> <span>Diploma of Website Development</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="project-content">
            ...
            <div class="site-container">
              ...
              <article class="article-card">
                <a href="https://web.brickin-it.screencraft.net.au/" class="card-category">
    ...
    <script>
      var typed = new Typed(".auto-input", {
        strings: ["Dylan Tan", "a Web Developer"],
        typeSpeed: 100,
        backSpeed: 100,
        loop: true
      })
